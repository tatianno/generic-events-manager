...
class GenericEventsManager():
    ...
    def _exec_routine_before_delete_obj(self, obj: GenericObject) -> None:
        ...
    
    def _exec_routine_after_delete_obj(self, obj: GenericObject) -> None:
        ...
    
    def objects_factory(self, data: dict)-> GenericObject:
    ...
    def exists(self, obj_key: str) -> GenericObject:
